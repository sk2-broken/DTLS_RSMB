...
/** Two more DTLS 'errors' to notify RSMB state machine that the packet isn't malformed 
	but is a DTLS handshake packet */
#define DTLS_WAIT_FINISHED -4
#define DTLS_FINISHED -5
